...
var chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%2b/index.html';
...
var Proxy = exports.Proxy = function Proxy(src, options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        xhr.onerror = reject;
        xhr.open('GET.html', proxy + '?url=' + encodeURIComponent(src) + '&responseType=' + responseType);
